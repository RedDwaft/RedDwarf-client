...
# provided arguments are: event, the incoming event, client: reference to pyreddwarf client
def printHello(event, client):
    print "You are logged!"
#register a callback function
client.registerListener(printHello, "on_loginSuccess")
client.connect()
